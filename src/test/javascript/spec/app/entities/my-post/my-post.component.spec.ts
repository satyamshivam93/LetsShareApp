...
import { MyPostComponent } from 'app/entities/my-post/my-post.component';
import { MyPostService } from 'app/entities/my-post/my-post.service';
import { MyPost } from 'app/shared/model/my-post.model';

describe('Component Tests', () => {
  describe('MyPost Management Component', () => {
    let comp: MyPostComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MyPostComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.myPosts && comp.myPosts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
